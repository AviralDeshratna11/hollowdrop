...
export const TEXTURE_REPEAT = 3; // Matches groundTexture.repeat.set(3, 3) in main.js
...
export function getTerrainHeight(x, z) {
  ...
  const boundarySlope = distFromOrigin > 80 ? Math.min((distFromOrigin - 80) * 0.06, 2.0) : 0;
