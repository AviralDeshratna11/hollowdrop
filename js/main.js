...
// nothing for a wrap mode to repeat or mirror at any edge. The image is a single
// full-map illustration (five distinct biome regions - violet crystal cave, icy crystal
// peaks, mossy green, a teal pool, molten red - not a small tileable pattern), so
// tiling it would both repeat those unique regions and reintroduce the mirror-seam
// problem a tiled MirroredRepeatWrapping setup had before. A single untiled copy has
// neither problem, and since both the plane and the texture are square the 1:1 UV
// mapping is not stretched or distorted in either axis. terrain.js's own GROUND_SIZE/
